...
from skidc.dispatcher.config import ContainerConfig
...
class ContainerManager:
    """Owns the per-project worker containers. Each project gets one long-lived
    container (`skidc-dispatch-<project>`); the dispatcher execs agent CLIs inside it."""

    _PREFIX = "skidc-dispatch-"
    _STARTUP_PREFIX = "skidc-startup-healthcheck-"
