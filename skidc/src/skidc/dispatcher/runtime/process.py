...
class ManagedProcess:
    """Wraps a single `docker exec` invocation with a background reader thread,
    so the dispatcher can enforce its own watchdog timeout, heartbeat-driven kill,
    and cooperative cancellation independent of the Docker SDK's blocking calls."""
